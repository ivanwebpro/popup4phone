<div class="wrap popup4phone_list_pointed">
	...
	<?php
		$rating_url = "https://wordpress.org/support/view/plugin-reviews/popup4phone#postform";
	?>
	<p><b><?php printf( __( 'If you like Popup4Phone please leave a %s rating', 'popup4phone' ), $this->html_a('&#9733;&#9733;&#9733;&#9733;&#9733;', $rating_url, array('target' => "_blank", 'style' => "text-decoration:none") ) );
	echo ":<br>";
	echo $this->html_a($rating_url, $rating_url, array('target' => "_blank", 'style' => "text-decoration:none") );
	echo "<br>";
	...
	<p><b><?php
		...
		_e( 'Support', 'popup4phone' );
		print ": ".$this->html_a($url, $url, array('target' => "_blank", 'style' => "text-decoration:none"));
	...
	<p><b><?php
		...
		//printf( ( 'Help to translate plugin on your language: %s', 'popup4phone' ), $this->html_a($url, $url, array('target' => "_blank", 'style' => "text-decoration:none")));
	...
	<ul>
		<li><?php _e( 'Auto popup with delay after loading of the page', 'popup4phone' );?></li>
		<li><?php _e( 'Popover/inline button, where the user can click and open the form', 'popup4phone' );?></li>
	...
	<ul>
		...
		<li><b> [popup4phone_button_inline]</b> &ndash; <?php _e( 'inline button for open form', 'popup4phone' );?></li>
	</ul>

<?php
/*
	<p><?php ( 'Also I recommend to use some trigger email service (like Mandrill) for a better deliverability', 'popup4phone' );?>. Mandrill: <A href = 'https://mandrillapp.com' target='_blank'>https://mandrillapp.com</A>, <?php ( 'plugin', 'popup4phone' )?>: <A href='https://wordpress.org/plugins/wpmandrill/' target='_blank'>https://wordpress.org/plugins/wpmandrill/</A></p>*/
